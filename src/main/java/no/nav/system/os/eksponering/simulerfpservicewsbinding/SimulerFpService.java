...
public interface SimulerFpService {
     ...
     * @param parameters
     * @return
     *     returns no.nav.system.no.nav.os.tjenester.simulerfpservice.simulerfpservicegrensesnitt.SendInnOppdragResponse
     ...
     * @param parameters
     * @return
     *     returns no.nav.system.no.nav.os.tjenester.simulerfpservice.simulerfpservicegrensesnitt.SimulerBeregningResponse
