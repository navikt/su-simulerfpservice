 ...
 * generated in the no.nav.system.no.nav.os.entiteter.oppdragskjema package.
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: no.nav.system.no.nav.os.entiteter.oppdragskjema
     * 
     */
