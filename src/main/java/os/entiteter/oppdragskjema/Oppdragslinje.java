...
import os.entiteter.typer.simpletypes.FradragTillegg;
import os.entiteter.typer.simpletypes.KodeArbeidsgiver;
import os.entiteter.typer.simpletypes.KodeStatusLinje;
...
@XmlSeeAlso({
    os.tjenester.simulerfpservice.simulerfpserviceservicetypes.Oppdragslinje.class
})
